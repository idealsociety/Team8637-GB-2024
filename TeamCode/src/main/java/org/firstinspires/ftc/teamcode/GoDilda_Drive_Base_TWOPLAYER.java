...
@TeleOp
public class GoDilda_Drive_Base_TWOPLAYER extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            {
             x = -gamepad1.left_stick_x * 2; // Counteract imperfect strafing this is front to back weight bias
            }else{ 
            ...
            if (clawa < 0.2 && wrista < 0.1 && gamepad2.dpad_left && motorExtendLeft.getCurrentPosition() > 600)
            {
                wrist.setPosition(0);
            }
